    ...
    async function Carregando() {
        for (var i = 0; i <= 7; i++) {
            ...
            if (i == 0) {
                ...
                div_imgCarregando.innerHTML = `<img src="Carregando 0%.png" style="border-radius: 50px;">`
                await timer(2);

            } else if (i == 1) {

                div_imgCarregando.innerHTML = `<img src="Carregando 25%.png" style="border-radius: 50px;">`
                await timer(2);

            } else if (i == 2) {

                div_imgCarregando.innerHTML = `<img src="Carregando 50%.png" style="border-radius: 50px;">`
                await timer(4);

            } else if (i == 3) {

                div_imgCarregando.innerHTML = `<img src="Carregando 75%.png" style="border-radius: 50px;">`
                await timer(4);

            } else if (i == 4) {

                div_imgCarregando.innerHTML = `<img src="Carregando 99%.png" style="border-radius: 50px;">`
                await timer(6);

            } else if (i == 5) {

                div_imgCarregando.innerHTML = `<img src="Carregando 100%.png" style="border-radius: 50px;">`
                await timer(1);
